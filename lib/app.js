...
const appElement = () => react.createElement("div", null, react.createElement("ul", null, stories.map(storyElement)));

function storyElement(story) {
  return react.createElement("li", null, react.createElement("button", {
    onClick: e => handleClick(story)
  }, story.likes, react.createElement("b", null, "\u2764\uFE0F")), react.createElement("a", null, story.name));
}
