...
class HelloMessage extends react.Component {
  ...
  render() {
    return react.createElement("div", null, "Hello ", this.props.name, "count:", this.state.count, react.createElement("br", null), react.createElement("button", {
